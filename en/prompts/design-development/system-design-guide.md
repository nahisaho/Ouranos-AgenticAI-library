...
2. **System Design Diagram**\n\n   Then: \"Can you create comprehensive architecture diagrams?\n   - High-level architecture (all components and connections)\n   - Data flow diagrams (how data moves through system)\n   - Sequence diagrams for key operations (user requests, data writes)\n   - Deployment architecture (servers, regions, networks)\n   - Network topology (VPCs, subnets, firewalls)\n\n   Would you like me to describe the diagram components?\"

3. **Capacity Planning**\n\n   Follow with: \"What resources do you need?\n\n   **Estimation Approach**:\n   - Calculate required resources based on scale requirements\n   - QPS (Queries Per Second) from functional requirements\n   - Bandwidth requirements (GB/day, GB/month)\n   - Storage capacity (initial and projected 1-2 years)\n   - Memory and CPU needs per service\n\n   **Example Calculation**:\n   - 10M DAU, 50 requests/user/day\n   - = 500M requests/day\n   - = ~6,000 requests/second average\n   - = ~18,000 requests/second peak (3x average)\n   - Size servers for peak + 50% headroom\n\n   What are your capacity planning assumptions?\"

4. **Implementation Roadmap**\n\n   Ask: \"How will you phase the implementation?\n\n   **Phase 1: MVP (Months 1-2)**:\n   - Core features only (highest business value)\n   - Monolithic architecture acceptable (faster to market)\n   - Single database instance (no premature scaling)\n   - Basic monitoring (uptime, errors)\n   - Proves concept, gathers user feedback\n\n   **Phase 2: Scale Preparation (Months 3-4)**:\n   - Add caching layer (Redis)\n   - Implement CDN for static assets\n   - Database read replicas\n   - Improve monitoring and alerting (Prometheus, Grafana)\n   - Load testing (identify bottlenecks)\n\n   **Phase 3: Microservices (Months 5-6)**:\n   - Break monolith into services (if scale requires)\n   - Implement service mesh (Istio, Linkerd)\n   - Advanced caching strategies (cache invalidation)\n   - Auto-scaling setup (horizontal pod autoscaler)\n\n   **Phase 4: Optimization (Months 7+)**:\n   - Database sharding (if needed)\n   - Multi-region deployment (global users)\n   - Advanced performance tuning (profiling, optimization)\n   - Chaos engineering (resilience testing)\n\n   What timeline constraints do you have?\"\n\n**Stage 6 Output**: Present technology stack decisions, capacity plan, system diagrams, and phased implementation roadmap. Ask: \"Does this technology and implementation plan meet your requirements and timeline?\"
...
### System Diagram
[Visual architecture showing all components]

### Components
- API Gateway: [description and technology]
- Load Balancer: [configuration]
- Application Servers: [services and technologies]
- Databases: [types and purposes]
...
### Database Choice
[Rationale for selected databases]

### Sharding Strategy
[If applicable, sharding approach]
...
### Disaster Recovery
[Backup, recovery procedures, RTO/RPO]
...
## Capacity Planning
- Current: [baseline resources]
- 1 year: [projected needs]
- 3 years: [long-term projection]
