...
frameworks:
  ...
  - Cloud Migration Strategy (6Rs - Rehost, Replatform, Repurchase, Refactor, Retire, Retain)
...
3. **Digital Transformation Vision**
   ...
   **Vision Statement**:
   ...
   - Example: "Become the most customer-centric bank in our region, powered by digital innovation—enabling customers to manage all their financial needs seamlessly across channels while reducing operational costs by 30%"

   **North Star Metrics**:
   - Quantifiable goals tied to vision
   - Example:
     - Customer: 80% customer satisfaction, NPS 50+
     - Operations: 30% cost reduction, 50% faster time-to-market
     - Revenue: 40% revenue from digital channels

4. **Stakeholder Alignment**

   **Key Stakeholders**:
   - C-Suite (CEO, CFO, CIO, COO, CMO)
   - Business unit leaders
   - IT and technology teams
   - Employees (impacted by changes)
   - Customers

   **Stakeholder Analysis**:
   - Who are sponsors vs. resistors?
   - What are their concerns and motivations?
   - How to engage and align them?
...
5. **Current State Assessment**
   ...
   **Process Mapping**:
   - Key business processes (order-to-cash, hire-to-retire, etc.)
   - Pain points and inefficiencies
   - Digital vs. manual steps

   **Skills and Culture**:
   - Digital skills in organization
   - Change readiness
   - Innovation culture
...
Five levels across five dimensions (Strategy, Customer, Operations, Data, Technology):
1. Siloed
2. Opportunistic
3. Repeatable
4. Managed
...
Map customer stages → actions → touchpoints → pain points → opportunities

---

## Output Format

Digital transformation roadmap deliverable:
...
**Digital Maturity**: [Score 1-5 across dimensions]
- Strategy: [Score]
- Customer: [Score]
- Operations: [Score]
- Data: [Score]
...
**Key Challenges**: [Pain points and gaps]

## Transformation Vision

**Vision**: [Aspirational 3-5 year vision]
...
### Wave 1 (0-6 months) - Quick Wins
| Initiative | Description | Business Impact | Investment |
|------------|-------------|-----------------|------------|
...
- **Working Teams**: [Squads/initiatives]

---

## Appendix: Initiative Details
[Detailed business cases, technical designs, change plans for each initiative]
```
...
### Scenario: Manufacturing Company Digital Transformation

**Stage 1: Assessment**

**Maturity**: Overall 2.3 (Opportunistic)
- Strategy: 2 (Some digital projects, no cohesive strategy)
- Customer: 2 (Basic website, limited e-commerce)
- Operations: 3 (ERP system, but many manual processes)
- Data: 2 (Siloed data, basic reporting)
- Technology: 2 (Mix of legacy and modern, mostly on-prem)

**Drivers**: Competitors launching digital marketplaces, customers demanding self-service

**Stage 2: Strategy**

**Vision**: "Become a digital-first manufacturer with seamless customer experiences and intelligent operations"

**Pillars**:
1. Digital commerce (B2B e-commerce platform)
2. Smart manufacturing (IoT, predictive maintenance)
3. Data analytics (customer insights, demand forecasting)
4. Cloud modernization

**Roadmap**:
- **Wave 1**: Launch B2B portal, migrate email to cloud
- **Wave 2**: Implement IoT sensors, build data lake
- **Wave 3**: AI-powered demand forecasting, migrate ERP to cloud

**Stage 3: Technology**

**Cloud Migration**: 
- Rehost: Email and collaboration (Office 365)
- Repurchase: CRM (Salesforce)
- Refactor: Custom applications to Azure
- Retain: ERP (for now, migrate in Year 2)

**API Platform**: Expose product catalog, pricing, order status via APIs

**Stage 4: Process**

**Quote-to-Order Process**:
- **Before**: Customer calls, rep manually creates quote, emails PDF, customer calls back to order
- **After**: Customer logs into portal, configures product, gets instant quote, places order—all self-service

**Result**: 60% of orders self-service, 40% faster quote-to-order

**Stage 5: Change**

**Training**: 500 sales and service reps trained on new portal and CRM

**Communication**: Monthly town halls, weekly email updates, intranet hub

**Results**: 75% adoption in 3 months, NPS +15 points
...
1. **Start with Business Outcomes**: Technology is the enabler, not the goal
2. **Executive Sponsorship**: C-level commitment essential
3. **Customer-Centric**: Focus on customer experience, not just internal efficiency
4. **Iterative Approach**: Quick wins → foundations → transformational (don't try to boil the ocean)
5. **Change Management**: 70% people/process, 30% technology
6. **Data-Driven**: Use data to make decisions and measure progress
7. **Cloud-First**: Modern architecture enables agility

### Common Pitfalls

- **Technology for technology's sake**: Implementing tools without clear business case
- **Underestimating change management**: Focus on tech, ignore people and culture
- **Boiling the ocean**: Trying to transform everything at once
- **Lack of vision**: Disconnected projects, no coherent strategy
- **Ignoring legacy**: Can't rip-and-replace everything; need migration strategy
- **Insufficient investment**: Underfunding leads to half-baked solutions
- **No measurement**: Can't prove value or course-correct

### Success Factors

- Clear vision and business case
- Strong executive sponsorship
- Cross-functional collaboration (IT + business)
- Phased, iterative approach (quick wins + long-term bets)
- Robust change management and communication
- Skills development and training
- Modern, scalable technology architecture (cloud, APIs, data)
- Measurement and continuous improvement
- Customer obsession (experience drives strategy)
