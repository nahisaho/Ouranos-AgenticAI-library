...
1. **A**wareness of need for change
2. **D**esire to support change
3. **K**nowledge of how to change
4. **A**bility to change
5. **R**einforcement to sustain change

### Kotter's 8-Step Change Model

Organization-level change process:
1. Create urgency
...
1. **Ending**: Let go of old
2. **Neutral Zone**: Transition (uncertainty)
3. **New Beginning**: Embrace new
...
Change management plan deliverable:
...
**Scope**: [Who/what is impacted]
**Timeline**: [Key milestones]

## Readiness Assessment

**Readiness Score**: [X/5]
- Previous change experience: [Score]
...
| Stakeholder Group | Power/Interest | Current State | Desired State | Engagement Approach |
|-------------------|----------------|---------------|---------------|---------------------|
| [Group] | [High/Low] | [Description] | [Description] | [Tactics] |

## Change Strategy

**ADKAR Approach**:
- **Awareness**: [Communication tactics]
- **Desire**: [Engagement tactics]
- **Knowledge**: [Training plan]
- **Ability**: [Support mechanisms]
- **Reinforcement**: [Sustainment tactics]

**Kotter's Steps**: [Map to 8 steps]

## Communication Plan

**Key Messages**: [Why, What, How, WIIFM, Call to Action]

**Communication Calendar**:
| Date | Audience | Message | Channel | Owner |
|------|----------|---------|---------|-------|
| [Date] | [Who] | [What] | [How] | [Name] |

## Training Plan

**Curriculum**: [Modules by role]
**Delivery**: [ILT, VILT, e-learning, etc.]
**Timeline**: [When]
...
**Metrics**: [Adoption, proficiency, business outcomes]
**Recognition**: [How we celebrate success]
...
- Change Lead: [Name]
- Change Champions: [Names/count]
- Managers: [Count]

---

## Appendix
- Detailed communication materials
- Training materials
- FAQs
- Metrics dashboard
```
...
### Scenario: Bank Implementing Agile Across Organization

**Stage 1: Assessment**

**Change**: Shift from waterfall to Agile methodology for all product teams (300 people)

**Why**: Faster time-to-market, customer responsiveness, competitive pressure

**Readiness**: 2.8/5 (Medium-Low)
- Previous change experience: 2 (failed ERP implementation, change fatigue)
- Leadership: 4 (CEO strongly committed)
- Culture: 2 (risk-averse, hierarchical)
- Resources: 3 (budget OK, but people are busy)

**Key Risk**: Cultural resistance (Agile requires autonomy, risk-taking, experimentation—counter to current culture)

**Stage 2: Strategy**

**ADKAR Approach**:
- **Awareness**: Town halls, business case videos, customer feedback showing need for speed
- **Desire**: Manager 1:1s addressing WIIFM, pilot teams as success stories
- **Knowledge**: 3-day Agile training for all teams, ongoing coaching
- **Ability**: 6-month pilot with 3 teams, coaches embedded, safe to experiment
- **Reinforcement**: Agile maturity metrics, recognition for high-performing teams

**Change Champions**: 20 early adopters across departments

**Stage 3: Communication**

**Key Message**: "Customers expect us to move faster. Agile gives teams the tools and autonomy to deliver value quickly. You'll have more ownership and less bureaucracy."

**Channels**: Weekly email updates, monthly town halls, manager cascade, Agile blog/intranet hub

**Stage 4: Training**

**Curriculum**:
- Agile 101 (half-day for all)
- Scrum Master certification (for Scrum Masters)
- Product Owner training (for POs)
- Agile coaching (weekly for teams)

**Support**: 10 Agile coaches embedded with teams for 6 months

**Stage 5: Results**

**6 months post-launch**:
- Adoption: 80% of teams running sprints
- Proficiency: Agile maturity score 3/5 (Intermediate)
- Business: Time-to-market reduced 30%, customer satisfaction +10 pts

**Lessons**: Cultural shift takes longer than expected; manager enablement critical; pilot teams' success stories powerful for building desire
...
1. **People Don't Resist Change, They Resist Being Changed**: Involve people, give them agency
2. **Start with Why**: Clear, compelling case for change
3. **Leaders Must Lead**: Role model, visible commitment, hold others accountable
4. **Communication Over-Communicate**: 7x7 rule (say it 7 times, 7 ways)
5. **Empathy Matters**: Acknowledge emotions, don't dismiss concerns
6. **Quick Wins Build Momentum**: Celebrate small successes early
7. **Change is a Journey, Not an Event**: Adoption takes time, support throughout

### Common Pitfalls

- **Underestimating people side**: Focus on technology/process, ignore culture and emotions
- **Lack of sponsorship**: No executive buy-in or visible support
- **Poor communication**: Infrequent, one-way, jargon-filled
- **Insufficient training**: Expect people to figure it out on their own
- **Declaring victory too soon**: Stop support before change is embedded
- **Ignoring resistance**: Hope it goes away instead of addressing root causes
- **Change for change's sake**: No clear business case or value

### Success Factors

- Strong, visible executive sponsorship
- Clear vision and compelling business case
- Comprehensive communication (frequent, multi-channel, two-way)
- Robust training and support
- Manager enablement (critical layer)
- Early wins and momentum
- Reinforcement and accountability
- Measurement and course correction
- Empathy and patience (change takes time)
