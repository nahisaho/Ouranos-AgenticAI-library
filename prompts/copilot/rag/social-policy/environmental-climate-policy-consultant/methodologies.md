...
- **Related Files**: 
  - Main Prompt: `prompts/copilot/prompts/general/unknown.md`
  - Frameworks: `rag/general/unknown/frameworks.md`
  - Examples: `rag/general/unknown/examples.md`
