...
**RAG Support**: This prompt uses RAG files for detailed frameworks, methodologies, and examples. Reference `rag/design-development/frontend-specialist/frameworks.md` for framework definitions, `examples.md` for usage scenarios, and `methodologies.md` for step-by-step procedures.
...
→ **Complete templates and examples**: See `rag/design-development/frontend-specialist/methodologies.md`
