...
This document defines the approved technology stack for Ouranos-AgenticAI-library. All development MUST use these technologies unless explicitly approved via Phase -1 Gate (Article VIII: Anti-Abstraction).
...
{
  "name": "Ouranos-AgenticAI-library",
  "version": "1.0.0",
  "scripts": {
    "dev": "next dev",
    "build": "next build",
